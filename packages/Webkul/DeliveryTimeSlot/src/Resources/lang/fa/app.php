...
return [
    'shop' => [
        ...
        'delivery-time-slot' => [
            ...
            'delivery-time-configuration' => 'Configuración de entrega de tiempo',
            'save-btn'                    => 'Ahorrar',
        ],
    ...
    'admin' => [
        'delivery-time-slot' => [
            ...
            'minimum-required-time' => [
               'title' => 'Días mínimos requeridos en el procesamiento del orden:',
        ...
        'datagrid' => [
            ...
            'delivery-orders'     => 'Pedidos de entrega',
            'delivery-time-slots' => 'Ranura de tiempo de entregas',
            'end-time'            => 'Hora de finalización',
            'start-time'          => 'Hora de inicio',
        ...
        'system' => [
            ...
            'setting' => [
                'title' => 'Ajustes',
                'info'  => 'Establecer opciones y mensajes de error.',
            ],
