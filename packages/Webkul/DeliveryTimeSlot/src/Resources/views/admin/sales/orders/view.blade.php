    ...
    <div class="grid">
        <div class="flex gap-3 justify-between items-center max-sm:flex-wrap">
            ...
            <div class="flex gap-[10px] items-center">
                ...
                <!-- Order Status -->
                <span class="{{ 'label-' . $order->status }} text-sm mx-1">
            ...
            <!-- Back Button -->
            <a href="{{ route('admin.sales.orders.index') }}" class="transparent-button hover:bg-gray-200 dark:hover:bg-gray-800 dark:text-white">
                @lang('admin::app.account.edit.back-btn')
            </a>
        </div>
    </div>

    <div class="justify-between gap-x-1 gap-y-2  items-center flex-wrap mt-3.5">
        <div class="flex gap-1">
            ...
            <form method="POST" ref="cancelOrderForm" action="{{ route('admin.sales.orders.cancel', $order->id) }}">
                @csrf
            </form>

            <div class="inline-flex gap-x-2 items-center justify-between w-full max-w-max px-1 py-1.5 text-gray-600 dark:text-gray-300 font-semibold text-center cursor-pointer transition-all hover:bg-gray-200 dark:hover:bg-gray-800 hover:rounded-[6px]" @click="$emitter.emit('open-confirm-modal', {
                        message: '@lang('shop::app.customers.account.orders.view.cancel-confirm-msg')',
                        agree: () => {
                            this.$refs['cancelOrderForm'].submit()
                        }
                    })">
                <span class="icon-cancel text-[24px]" role="presentation" tabindex="0">
                </span>
        ...
        <div class="flex gap-2 mt-3 max-xl:flex-wrap">
            ...
            <div class="flex flex-col gap-2 flex-1 max-xl:flex-auto">
                <div class="bg-white dark:bg-gray-900 rounded-[4px] box-shadow">
                    ...
                    <div class="grid">
                        ...
                        <div class="flex gap-2 justify-between px-3 py-6 border-b-1 border-slate-300 dark:border-gray-800">
                            <div class="flex gap-2">
                                @if($item?->product?->base_image_url)
                                <img class="w-full h-[60px] max-w-[60px] max-h-[60px] relative rounded-[4px]" src="{{ $item?->product->base_image_url }}">
                                @else
                                <div class="w-full h-[60px] max-w-[60px] max-h-[60px] relative border border-dashed border-gray-300 dark:border-gray-800 rounded-[4px] dark:invert dark:mix-blend-exclusion">
                                    ...
                                    <p class="absolute w-full bottom-1 text-xs text-gray-400 text-center font-semibold">
                    ...
                    <div class="flex w-full gap-2 justify-end mt-3 p-3">
                        <div class="flex flex-col gap-y-1.5">
                            ...
                            <p class="text-3 text-gray-800 dark:text-white font-semibold">
                ...
                <div class="bg-white dark:bg-gray-900 rounded box-shadow">
                    <p class="p-3 pb-0 text-base text-gray-800 dark:text-white font-semibold">
                        ...
                        <div class="p-3">
                            <div class="mb-[10px]">
                                <x-admin::form.control-group>
                                    <x-admin::form.control-group.control type="textarea" name="comment" id="comment" rules="required" :label="trans('admin::app.sales.orders.view.comments')" :placeholder="trans('admin::app.sales.orders.view.write-your-comment')" rows="3">
                            ...
                            <div class="flex justify-between items-center">
                                <label class="flex gap-1 w-max items-center p-3.5 cursor-pointer select-none" for="customer_notified">
                                    <input type="checkbox" name="customer_notified" id="customer_notified" value="1" class="hidden peer">

                                    <span class="icon-uncheckbox rounded-[6px] text-[24px] cursor-pointer peer-checked:icon-checked peer-checked:text-blue-600" role="button" tabindex="0">
                                    </span>
                                ...
                                <button type="submit" class="secondary-button" aria-label="{{ trans('admin::app.sales.orders.view.submit-comment') }}">
            ...
            <div class="flex flex-col gap-2 w-[360px] max-w-full max-sm:w-full">
                ...
                <x-admin::accordion>
                    ...
                    <x-slot:content>
                        <div class="{{ $order->billing_address ? 'pb-3' : '' }}">
                        ...
                        <div class="{{ $order->shipping_address ? 'pb-3' : '' }}">
                ...
                <x-admin::accordion>
                    <x-slot:header>
                        <p class="text-gray-600 dark:text-gray-300 text-base p-1.5 font-semibold">
                    ...
                    <x-slot:content>
                        ...
                        @if ($order->shipping_address)
                        <span class="block w-full mt-3 border-b-2 dark:border-gray-800"></span>
                    ...
                    <x-slot:content>
                        ...
                        <div class="grid gap-y-2.5">
                            ...
                            <div class="flex gap-3">
                                <a href="{{ route('admin.sales.invoices.view', $invoice->id) }}" class="text-[14px] text-blue-600 transition-all hover:underline">
                                    @lang('admin::app.sales.orders.view.view')
                                </a>

                                <a href="{{ route('admin.sales.invoices.print', $invoice->id) }}" class="text-[14px] text-blue-600 transition-all hover:underline">
                        ...
                        @if ($index < count($order->invoices) - 1)
                            <span class="block w-full mb-3 mt-3 border-b-[1px] dark:border-gray-800  "></span>
                            @endif
                            @empty
                            <p class="text-gray-600 dark:text-gray-300">
                    ...
                    <x-slot:content>
                        ...
                        <div class="grid gap-y-2">
                            ...
                            <div class="flex gap-[10px]">
                                <a href="{{ route('admin.sales.shipments.view', $shipment->id) }}" class="text-[14px] text-blue-600 transition-all hover:underline">
                                    @lang('admin::app.sales.orders.view.view')
                                </a>
                            </div>
                        </div>
                    ...
                    <x-slot:content>
                        ...
                        <div class="grid gap-y-2">
                            <div>
                                ...
                                <p class="mt-3 text-gray-800 dark:text-white font-semibold">
                            ...
                            <div class="flex gap-2">
                                <a href="{{ route('admin.sales.refunds.view', $refund->id) }}" class="text-[14px] text-blue-600 transition-all hover:underline">
                                    @lang('admin::app.sales.orders.view.view')
                                </a>
                            </div>
                        </div>
