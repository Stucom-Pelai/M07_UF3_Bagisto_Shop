            ...
            >
                ...
                <div class="relative overflow-x-auto mt-[30px] border rounded-[12px]">
                    <table class="w-full text-sm text-left ">
                        <thead class="bg-[#F5F5F5] border-b-[1px] border-[#E9E9E9] text-base text-black">
                            <tr>
                                <th
                                    scope="col"
                                    class="px-6 py-3.5 font-medium"
                                >
                        ...
                        <tbody>
                            @foreach ($order->items as $item)
                                <tr class="bg-white border-b">
                                    <td
                                        class="px-6 py-3.5 text-black font-medium"
                ...
                @if (! empty($timeSlotData))
                    @foreach ($timeSlotData as $key => $timeSlot)
                        @foreach ($timeSlot['items'] as $timeSlotItem)
                            ...
                            @if (
                                $timeSlotItem['id'] == $item->id 
                                && ! is_null($timeSlot['timeOrderSlot'])
                            ) 
                                <div class="flex justify-start mt-[30px]">
                                    <div class="grid gap-[8px] max-w-max">
                                        <div class="flex gap-x-2 justify-between w-full">
                                            <p class="text-base font-semibold">
                                                @lang('delivery-time-slot::app.shop.customers.account.orders.delivery-date-day')
                                            </p>
                                        ...
                                        <div class="flex gap-x-2 justify-between w-full">
                                            <p class="text-base font-semibold">
                                                @lang('delivery-time-slot::app.shop.customers.account.orders.delivery-time')
                                            </p>
                                            <p class="text-base">-</p>
                ...
                <x-shop::tabs.item title="{{__('shop::app.customers.account.orders.view.shipments.shipments') }}">
                    ...
                    @foreach ($order->shipments as $shipment)
                        ...
                        <div class="relative overflow-x-auto border rounded-[12px] mt-[30px]">
                            <table class="w-full text-sm text-left">
                                <thead class="text-base text-black bg-[#F5F5F5] border-b-[1px] border-[#E9E9E9]  ">
                                    <tr>
                                        <th
                                            scope="col"
                                            class="px-6 py-3.5 font-medium"
